...
const Featured = () => {
  return (
    <div
      className="featured-item bg-fixed text-white pt-8 my-20 mx-10 md:mx-0"
      style={{
        backgroundImage: `url("https://i.ibb.co/wwST23f/featured.jpg")`,
    ...
    >
      ...
      ></SectionTitle>
      <div className="md:flex justify-center items-center bg-slate-800 bg-opacity-40 pb-20 pt-12 px-10">
        <div>
